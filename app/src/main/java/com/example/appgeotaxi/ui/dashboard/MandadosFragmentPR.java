...
public class MandadosFragmentPR extends Fragment {
    ...
    MandadosFragmentPR mandadosFragment;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_mandados_pr, container, false);
...
/*
    ...
    public MandadosFragmentPR(String User_FK, String TR_origin, String TR_destination, String TR_description, String TR_price){
                ...
                try {
                    ...
                    if (exito.equals("1")) {
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            mandadosFragment = new MandadosFragmentPR(user, origin, destination, description, price);
